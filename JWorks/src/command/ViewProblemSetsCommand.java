...
public class ViewProblemSetsCommand extends Command {
    /**
     ...
     */
    public ViewProblemSetsCommand(DatabaseAPI databaseAPI, OutputGen outputStream) {
     ...
     *
     * @param args the arguments for the command to use. No arguments are used in this command.
